...
LANGUAGE = {
	...
	charKD = "Your PvP K/D against players is %s/%s (%s).",
	charFaction = "You are a member of the %s faction.",
	charClass = "You are %s of the faction.",
	noSpace = "Inventory is Full.",
	nxCarryOverLimit = "You are carrying too much. Equip better gear or drop items.",
	nxGearSlotTaken = "You are already using that gear slot.",
	nxUnequipFirst = "Unequip this gear before moving or dropping it.",
